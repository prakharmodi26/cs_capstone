...
# SLURM headers removed - not using SLURM

# module load lines removed - not available on this cluster

# Activate conda env
source /home/courses/cs4094/shared/group10/miniconda3/etc/profile.d/conda.sh
...
sample_num=5000
model_path=${4:-/home/courses/cs4094/shared/group10/models/Llama-3.1-8B}
...
cd /home/courses/cs4094/shared/group10/project/Booster
